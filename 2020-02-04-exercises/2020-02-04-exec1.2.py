...
name = input("Hello, what is your first name? :    ").capitalize()
...
age = int(input (f"Gorgeous! And finally {name}, how old are you? :    "))


print (f"Hello {name}, you have {eye_colour} eyes and {hair_colour} hair, and you are {age} years old. Have a nice day! :)")
print (f"Also {name}, I predict you were born in {2020 - age} or {2020 - 1 - age}, as you said you were {age} years old!")